...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 ${scrolling ? 'shadow-md transition-shadow duration-1000' : ''} py-2 px-4 md:px-12 lg:px-16 flex items-center justify-between transition-shadow`}>
